...
a1 = NULL
a2 = read.delim('/Users/deven/Desktop/r.txt', header=TRUE)
a3 = 'asas'
a4 <- c('asas')
a5 = 'gaussian'
a6 <- c('both')
newdata <- ewas(a1,a2,a3,a4,a5,a6)
write.table(newdata,file='GUI_Output/NHANES_Unique_ewas.txt',sep='\t', row.names=FALSE, quote=FALSE)
